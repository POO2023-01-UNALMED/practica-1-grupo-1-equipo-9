...
public class main {
	...
	public static void main(String[] args) {
		Articulo articulo22 = new Articulo("premium", "repuesto", "Motor", "Bomba de agua", "automóvil", "Airtex", 350000, 10, "Toyota",2001);
		Articulo articulo23 = new Articulo("premium", "repuesto", "Escape", "Silenciador", "automóvil", "MagnaFlow", 1200000, 5, "Chevrolet",2002);
		Articulo articulo24 = new Articulo("premium", "repuesto", "Sonido", "Sistema de audio", "automóvil", "JBL", 1500000, 3, "Mazda",2003);
		Articulo articulo25 = new Articulo("premium", "repuesto", "Suspension", "Amortiguador", "camioneta", "Bilstein", 850000, 8, "Toyota",2004);
		Articulo articulo26 = new Articulo("premium", "repuesto", "Motor", "Filtro de aire", "automóvil", "K&N", 180000, 20, "Chevrolet",2005);
		Articulo articulo27 = new Articulo("premium", "repuesto", "Escape", "Sistema de escape deportivo", "automóvil", "BORLA", 2500000, 2, "Mazda",2006);
		Articulo articulo28 = new Articulo("premium", "repuesto", "Sonido", "Subwoofer", "automóvil", "Alpine", 650000, 6, "Toyota",2007);
		Articulo articulo29 = new Articulo("premium", "repuesto", "Suspension", "Kit de levante", "camioneta", "Rancho", 3200000, 1, "Chevrolet",2008);
		Articulo articulo30 = new Articulo("premium", "repuesto", "Motor", "Bujías de alto rendimiento", "automóvil", "NGK", 140000, 15, "Mazda",2009);
		Articulo articulo31 = new Articulo("premium", "repuesto", "Escape", "Cabezal de escape", "automóvil", "Gibson", 2100000, 4, "Toyota",2010);

		Articulo articulo32 = new Articulo("Basico","repuesto","Motor", "Filtro de aire", "automóvil", "FRAM", 45000, 100, "Mazda",2011);
		Articulo articulo33 = new Articulo("Basico","repuesto","Motor", "Bujías", "automóvil", "NGK", 40000, 80, "Toyota",2012);
		Articulo articulo34 = new Articulo("Basico","repuesto","Escape", "Silenciador", "automóvil", "Walker", 150000, 50, "Chevrolet",2013);
		Articulo articulo35 = new Articulo("Basico","repuesto","Escape", "Tubo de escape", "automóvil", "Bosal", 80000, 60, "Mazda",2014);
		Articulo articulo36 = new Articulo("Basico","repuesto","Sonido", "Radio FM/AM", "automóvil", "Sony", 180000, 30, "Toyota",2015);
		Articulo articulo37 = new Articulo("Basico","repuesto","Sonido", "Parlantes", "automóvil", "Pioneer", 120000, 40, "Chevrolet",2016);
		Articulo articulo38 = new Articulo("Basico","repuesto","Suspension", "Amortiguador", "automóvil", "Monroe", 100000, 70,2017);
		Articulo articulo39 = new Articulo("Basico","repuesto","Suspension", "Esfera de suspensión", "automóvil", "Sachs", 65000, 90,2018);
		Articulo articulo40 = new Articulo("Basico","repuesto","Motor", "Bomba de agua", "automóvil", "Gates", 80000, 60,2019);
		Articulo articulo41 = new Articulo("Basico","repuesto","Motor", "Correa de distribución", "automóvil", "Continental", 60000, 80,2020);

Articulo articulo123 = new Articulo("Basico", "repuesto", "Motor", "Filtro de aire", "automóvil", "Airtex", 45000, 100, "Mazda", 7155);

		Articulo articulo124 = new Articulo("Basico", "repuesto", "Motor", "Bujía de encendido", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 9496);
		
		Articulo articulo125 = new Articulo("Basico", "repuesto", "Motor", "Filtro de aire", "automóvil", "JBL", 45000, 100, "Toyota", 6465);

		Articulo articulo126 = new Articulo("Basico", "repuesto", "Motor", "Bujía de encendido", "automóvil", "Toyota", 55000, 50, "Toyota", 5071);

		Articulo articulo127 = new Articulo("Basico", "repuesto", "Motor", "Filtro de aire", "automóvil", "Toyota", 45000, 100, "Chevrolet", 8465);

		Articulo articulo128 = new Articulo("Basico", "repuesto", "Motor", "Bujía de encendido", "automóvil", "Airtex", 55000, 50, "Chevrolet", 9699);
		
		Articulo articulo129 = new Articulo("Basico", "repuesto", "Freno", "Frenos de disco delantero", "automóvil", "Airtex", 45000, 100, "Mazda", 5151);

		Articulo articulo130 = new Articulo("Basico", "repuesto", "Freno", "Frenos de tambor delanteros y traseros", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 9418);
		
		Articulo articulo131 = new Articulo("Basico", "repuesto", "Freno", "Frenos de tambor traseros", "automóvil", "JBL", 45000, 100, "Toyota", 6860);

		Articulo articulo132 = new Articulo("Basico", "repuesto", "Freno", "Frenos de tambor delanteros", "automóvil", "Toyota", 55000, 50, "Toyota", 8282);

		Articulo articulo133 = new Articulo("Basico", "repuesto", "Freno", "Frenos de tambor traseros", "automóvil", "Toyota", 45000, 100, "Chevrolet", 6039);

		Articulo articulo134 = new Articulo("Basico", "repuesto", "Freno", "Frenos de disco delanteros y traseros", "automóvil", "Airtex", 55000, 50, "Chevrolet", 6828);
		
		Articulo articulo135 = new Articulo("Basico", "repuesto", "Suspension", "Kit de levante", "automóvil", "Airtex", 45000, 100, "Mazda", 5591);

		Articulo articulo136 = new Articulo("Basico", "repuesto", "Suspension", "Amortiguador", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 9332);
		
		Articulo articulo137 = new Articulo("Basico", "repuesto", "Suspension", "Esfera de suspensión", "automóvil", "JBL", 45000, 100, "Toyota", 6857);

		Articulo articulo138 = new Articulo("Basico", "repuesto", "Suspension", "Esfera de suspensión", "automóvil", "Toyota", 55000, 50, "Toyota", 9906);

		Articulo articulo139 = new Articulo("Basico", "repuesto", "Suspension", "Kit de levante", "automóvil", "Toyota", 45000, 100, "Chevrolet", 9052);

		Articulo articulo140 = new Articulo("Basico", "repuesto", "Suspension", "Amortiguador", "automóvil", "Airtex", 55000, 50, "Chevrolet", 7193);
		
		Articulo articulo141 = new Articulo("Basico", "repuesto", "Sonido", "Radio FM/AM", "automóvil", "Airtex", 45000, 100, "Mazda", 5742);

		Articulo articulo142 = new Articulo("Basico", "repuesto", "Sonido", "Parlantes", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 9203);
		
		Articulo articulo143 = new Articulo("Basico", "repuesto", "Sonido", "Radio FM/AM", "automóvil", "JBL", 45000, 100, "Toyota", 9203);

		Articulo articulo144 = new Articulo("Basico", "repuesto", "Sonido", "Parlantes", "automóvil", "Toyota", 55000, 50, "Toyota", 6578);

		Articulo articulo145 = new Articulo("Basico", "repuesto", "Sonido", "Radio FM/AM", "automóvil", "Toyota", 45000, 100, "Chevrolet", 5984);

		Articulo articulo146 = new Articulo("Basico", "repuesto", "Sonido", "Parlantes", "automóvil", "Airtex", 55000, 50, "Chevrolet", 6101);
		
		Articulo articulo147 = new Articulo("Premium", "repuesto", "Motor", "Filtro de aire", "automóvil", "Airtex", 45000, 100, "Mazda", 6713);

		Articulo articulo148 = new Articulo("Premium", "repuesto", "Motor", "Bujía de encendido", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 5064);
		
		Articulo articulo149 = new Articulo("Premium", "repuesto", "Motor", "Bomba de agua", "automóvil", "JBL", 45000, 100, "Toyota", 8879);

		Articulo articulo150 = new Articulo("Premium", "repuesto", "Motor", "Bujía de encendido", "automóvil", "Toyota", 55000, 50, "Toyota", 8059);

		Articulo articulo151 = new Articulo("Premium", "repuesto", "Motor", "Filtro de aire", "automóvil", "Toyota", 45000, 100, "Chevrolet", 9180);

		Articulo articulo152 = new Articulo("Premium", "repuesto", "Motor", "Bomba de agua", "automóvil", "Airtex", 55000, 50, "Chevrolet", 8221);
		
		Articulo articulo153 = new Articulo("Premium", "repuesto", "Freno", "Frenos de tambor delanteros y traseros", "automóvil", "Airtex", 45000, 100, "Mazda", 5735);

		Articulo articulo154 = new Articulo("Premium", "repuesto", "Freno", "Frenos de disco delantero", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 7366);
		
		Articulo articulo155 = new Articulo("Premium", "repuesto", "Freno", "Frenos de tambor traseros", "automóvil", "JBL", 45000, 100, "Toyota", 6931);

		Articulo articulo156 = new Articulo("Premium", "repuesto", "Freno", "Frenos de disco delantero y trasero", "automóvil", "Toyota", 55000, 50, "Toyota", 6536);

		Articulo articulo157 = new Articulo("Premium", "repuesto", "Freno", "Frenos de disco delantero", "automóvil", "Toyota", 45000, 100, "Chevrolet", 8832);

		Articulo articulo158 = new Articulo("Premium", "repuesto", "Freno", "Frenos de tambor traseros", "automóvil", "Airtex", 55000, 50, "Chevrolet", 5722);
		
		Articulo articulo159 = new Articulo("Premium", "repuesto", "Suspension", "Esfera de suspensión", "automóvil", "Airtex", 45000, 100, "Mazda", 6257);

		Articulo articulo160 = new Articulo("Premium", "repuesto", "Suspension", "Amortiguador", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 5211);
		
		Articulo articulo161 = new Articulo("Premium", "repuesto", "Suspension", "Kit de levante", "automóvil", "JBL", 45000, 100, "Toyota", 8234);

		Articulo articulo162 = new Articulo("Premium", "repuesto", "Suspension", "Kit de levante", "automóvil", "Toyota", 55000, 50, "Toyota", 5556);

		Articulo articulo163 = new Articulo("Premium", "repuesto", "Suspension", "Amortiguador", "automóvil", "Toyota", 45000, 100, "Chevrolet", 5923);

		Articulo articulo164 = new Articulo("Premium", "repuesto", "Suspension", "Esfera de suspensión", "automóvil", "Airtex", 55000, 50, "Chevrolet", 9279);
		
		Articulo articulo165 = new Articulo("Premium", "repuesto", "Sonido", "Parlantes", "automóvil", "Airtex", 45000, 100, "Mazda", 6212);

		Articulo articulo166 = new Articulo("Premium", "repuesto", "Sonido", "Radio FM/AM", "automóvil", "MagnaFlow", 55000, 50, "Mazda", 6806);
		
		Articulo articulo167 = new Articulo("Premium", "repuesto", "Sonido", "Parlantes", "automóvil", "JBL", 45000, 100, "Toyota", 5395);

		Articulo articulo168 = new Articulo("Premium", "repuesto", "Sonido", "Radio FM/AM", "automóvil", "Toyota", 55000, 50, "Toyota", 5588);

		Articulo articulo169 = new Articulo("Premium", "repuesto", "Sonido", "Parlantes", "automóvil", "Toyota", 45000, 100, "Chevrolet", 7004);

		Articulo articulo170 = new Articulo("Premium", "repuesto", "Sonido", "Parlantes", "automóvil", "Airtex", 55000, 50, "Chevrolet", 7091);
	...
	public static void procesoVenta() {
		...
		} while(presupuestoInsuficiente==false);
	}
	...
	public static void procesoTaller() {
		...
		if (confirmarPrp.equals("si")) {
			...
			ArrayList<Articulo> producto=InventarioArticulo.articulosDispo(mecanico);
			//Selector
	...
	public static void personalizarAuto() {
		...
		if (opcionTaller.equalsIgnoreCase("taller")) {
		    ...
		    System.out.print("Ingrese el número de la opción que va a utilizar: ");
			    ...
			    if (mecanicos.size() >= 1) {
	                ...
	                if (confirmarTrans.equalsIgnoreCase("si")) {
	                    ...
	                    for (int i = 0; i < mecanico.getHorario().size(); i++) {
	                        System.out.println((i + 1) + ". " + mecanico.getHorario().get(i));
	                    }

	                    do {
	                        System.out.print("Seleccione el número de hora [1-" + mecanico.getHorario().size() + "]: ");
	                        num1 = sc.nextInt();
	                        sc.nextLine();

	                        if (num1 < 1 || num1 > mecanico.getHorario().size()) {
	                            System.out.println("Opción inválida. Introduzca un número válido.");
	                        }
	                    } while (num1 < 1 || num1 > mecanico.getHorario().size());

	                    System.out.println("La hora de su cita es: " + mecanico.getHorario().get(num1 - 1));
	    	...
	    	System.out.println("Ha seleccionado utilizar nuestro menu de ventas de articulos");
		     ...
		     ArrayList<Articulo> producto = InventarioArticulo.selectorModificacion();
		     Articulo articulo=null;
		   //Selector
		 	    String resultp = String.format("%-15s%-40s%-25s%-40s%-15s%-15s%n", "   Referencia","   Producto", "   Tipo Vehiculo", "   Marca", "   Precio","Cantidad");
		 	    byte i=0;
		 	    for (Articulo articuloi:producto) {
		 	        ...
		 	        System.out.println("Los productos " + producto.get(0).getEspecialidad() + " disponibles son:\n");
		 	        System.out.println(resultp);
		 	        int num = 0;
		 	        while (num <= 0 || num > producto.size()) {
		 	            System.out.println("Seleccione el numero del producto" + "[1-" + producto.size() + "]: ");
		     ...
		     System.out.print("¿Confirmar vendedor? (si/no)");
		 	   ...
		 	   if(!confirmarVendedor.equals("no")) {
		 		   	String confirmarTrans=null;
		 		    System.out.println("El costo total de la transacción es: " + articulo.getPrecio());
